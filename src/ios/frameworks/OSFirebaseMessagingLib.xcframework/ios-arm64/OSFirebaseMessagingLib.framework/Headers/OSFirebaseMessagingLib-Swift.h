...
@interface FirebaseMessagingApplicationDelegate : NSObject <UIApplicationDelegate>
...
///
/// \param launchOptions Dictionary indicating the reason the app was launched.
///
///
/// returns:
/// Informs that it’s ready to work.
...
///
/// \param completionHandler Block to execute when the download operation is complete.
///
...
@interface FirebaseMessagingApplicationDelegate (SWIFT_EXTENSION(OSFirebaseMessagingLib)) <UNUserNotificationCenterDelegate>
...
/// \param center Shared user notification center object that received the notification.
///
/// \param notification Notification that is about to be delivered.
///
/// \param completionHandler Block to execute with the presentation option for the notification.
///
...
///
/// \param completionHandler Block to execute when you have finished processing the user’s response.
///
...
SWIFT_CLASS_NAMED("OSFCMExtraData")
@interface OSFCMExtraData : NSManagedObject
